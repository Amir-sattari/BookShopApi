...
namespace BookShopApi.Migrations
{
    ...
    [Migration("20260904180000_AddOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShopApi.Models.BookDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShopApi.Models.Coupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShopApi.Models.CouponUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShopApi.Models.StockNotificationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShopApi.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("BookDiscountTotal")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("BookShopApi.Models.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShopApi.Models.ShippingMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CouponBooks", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookShopApi.Models.CouponUsage", b =>
                {
                    b.HasOne("BookShopApi.Models.Coupon", "Coupon")
                        .WithMany("Usages")
            ...
            modelBuilder.Entity("BookShopApi.Models.StockNotificationRequest", b =>
                {
                    b.HasOne("BookShopApi.Models.Book", "Book")
                        .WithMany("StockNotificationRequests")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookShopApi.Models.Order", b =>
                {
                    b.HasOne("BookShopApi.Models.ShippingAddress", "ShippingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("CouponBooks", b =>
                {
                    b.HasOne("BookShopApi.Models.Book", null)
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BookShopApi.Models.Coupon", null)
                        .WithMany()
                        .HasForeignKey("CouponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookShopApi.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("StockNotificationRequests");
                });
